...
from processing.dalia.ecg_quality_measure import ECGQualityMeasure
...
class FeatureExtractor:
    ...
    def calculate_bpm(self, patient):
        """
            ...
            The ground truths of the heart rate are present under the labels.csv file for each patient
        """
        bpm_window = []
